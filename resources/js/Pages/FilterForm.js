...
export default function FilterForm(props) {
    ...
    return (
        <form className={`pl-6 pr-6 h-35 grid grid-cols-${props.cols} gap-4 content-center text-${props.color}`} onSubmit={props.handleSubmit}>
            ...
            <div className="form-group">
                ...
                <span>
                    { (props.windowWidth > 1155 && props.cols == 3) ? (
